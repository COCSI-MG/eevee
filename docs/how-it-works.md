...
flowchart LR
    ...
    A --> O[organiza em uma prova - opcional]
    O --> E[Estudante acessa o workspace]
...
| Prova | Agrupamento de atividades da mesma turma, com pontos e datas opcionais. |
| Template de teste | Teste automatizado reutilizável preparado pelo professor. |
| Gabarito | Solução de referência que pode ser testada e liberada pelo professor. |
...
O professor cria uma turma, seleciona os estudantes e prepara os templates de teste. Depois, cria uma atividade informando seu enunciado, código inicial, executor e número máximo de tentativas. Também pode preparar um gabarito e reunir atividades em uma prova.
...
- [Provas do estudante](student-guide/exams.md)
