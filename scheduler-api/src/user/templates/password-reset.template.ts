        ...
        <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 24px 32px;">
              ...
              <p style="margin: 4px 0 0 0; font-size: 13px; color: #3B82F6; word-break: break-all;">
                <a href="${resetUrl}" target="_blank" style="color: #3B82F6;">${resetUrl}</a>
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding: 0 32px 32px 32px;">
              ...
              <p style="margin: 0; font-size: 12px; color: #a1a1aa;">
                Este link expira em <strong style="color: #52525b;">1 hora</strong>.
                Se você não solicitou esta redefinição, ignore este e-mail.
              </p>
              <p style="margin: 12px 0 0 0; font-size: 12px; color: #a1a1aa;">
                &copy; ${new Date().getFullYear()} EEVEE CEFET Code Lab
              </p>
            </td>
          </tr>
        </table>
